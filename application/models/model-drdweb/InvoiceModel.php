...
{	
	...
	public function invoice_send_email_whatsapp(){
		...
		foreach($result as $row){
			...
			$notification_whatsapp_message = $whatsapp_message = "Hello <br>$chemist_name ($chemist_id), <br><br>Invoice No. *$gstvno* for order dated $newdate of the value around *Rs.$amt/-* has been generated by *D.R. Distributors Pvt. Ltd.*. <br>$whatsapp_message_delete <br><br>You can check your invoice by clicking on <br>$link<br><br>You can download your invoice by clicking on <br>$download_link <br><br>On laptop or pc you can visit following link to start placing orders : <br> $website_link <br><br>Please download our app from Google play store : ".$android_link;

			/****************notification***********************/
            $q_title 		= "Invoice No. - $gstvno";
            $q_message		= $notification_whatsapp_message;
            $this->NotificationModel->insert_notification("5",$q_title,$q_message,$chemist_id,"chemist");
            /*****************whatsapp*************************/
