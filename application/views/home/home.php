...
<div class="container-fluid maincontainercss">
	...
	<?php if($row->type=="divisioncategory"){ ?>
		<div class="col-xs-12 col-sm-12 col-12">
			<div class="featured_home_title">
				<h1 class="heading_home">
					<span class="divisioncategory_title_<?php echo $row->category_id ?>">
					Loading....
					</span>
				</h1>
			</div>
			<section class="featured_home" id="featured_home">
				<div class="swiper featured_home-slider featured-slider">
					<div class="swiper-wrapper divisioncategory_result_<?php echo $row->category_id ?>">
		...
		<div class="col-xs-12 col-sm-12 col-12 itemcategory_div_<?php echo $row->category_id ?>">
			<div class="featured_home_title">
				<h1 class="heading_home">
					<a href="<?= base_url(); ?>home/medicine_category/medicine_item_wise/<?php echo $row->category_id ?>">	
						<span class="itemcategory_title_<?php echo $row->category_id ?>">
						Loading....
						</span>
					</a>
				</h1>
			...
			<section class="featured_home" id="featured_home">
				<div class="swiper featured_home-slider featured-slider1">
					<div class="swiper-wrapper itemcategory_result_<?php echo $row->category_id ?>">
				...
				$.each(data.get_result, function(i,work){
					...
					$.each(work.divisioncategory_result_<?php echo $row->category_id; ?>, function(i,item){	
						if (item){
							...
							$(".divisioncategory_result_<?php echo $row->category_id; ?>").append('<div class="swiper-slide box"><div class="mcs-items-container1"><div class="home_main_div"><div class="image1"><a href="<?= base_url(); ?>home/medicine_category/featured_brand/'+item_code+'/'+item_division+'"><img src="'+item_image+'" alt=""></a></div><div class="content" style="padding-top:5px;"><a href="<?= base_url(); ?>home/featured_brand/'+item_code+'/'+item_division+'"><div class="medicine_details_item_company">'+item_company+'</div></a></div></div></div></div>');
						}
					});
				});
				<?php } ?>
