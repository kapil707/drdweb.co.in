	...
	<div class="top_menu_bar">
		<div class="container">
			<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-3 col-xs-4 col-12">
					<span style="float:left; margin-right:10px;">
						...
						<a href="javascript:new_style_menu_show()" class="menubtn1" style="color:white;" title="Drd Menu">
							<img src="<?= base_url() ?>img_v<?= constant('site_v') ?>/logo2.png" class="main_white_logo" alt="Dr. Distributor" title="Dr. Distributor">
						</a>
					</span>
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-4 col-12">
				...
				<div class="col-sm-3 mobile_off text-right" style="margin-top:5px;">	
					...
					<a class="top_menu_small_btn mobile_off" title="Logout" href="javascript:void(0);" onclick="logout_function()">
