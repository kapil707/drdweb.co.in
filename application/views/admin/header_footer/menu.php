<nav class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
			...
			if(!empty($menu)){?>
				<li <?php if($Page_menu=="manage_home" || $Page_menu=="manage_medicine_menu" || $Page_menu=="manage_slider" || $Page_menu=="manage_item_wise" || $Page_menu=="manage_item_category" || $Page_menu=="manage_company_division" || $Page_menu=="manage_company_division_category") { ?> class="active" <?php } ?>>
				<a href="#">
					<span class="nav-label">
						<i class="fa fa-th-large"></i>
							Manage Home
