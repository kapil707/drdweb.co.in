<nav class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
			...
			<?php } 
			$menu = $this->db->query("select DISTINCT tbl_permission_settings.page_type,sorting_order from tbl_permission_settings,tbl_permission_page where tbl_permission_settings.page_type=tbl_permission_page.page_type and user_type='$user_type' and (tbl_permission_settings.page_type='manage_broadcast' or tbl_permission_settings.page_type='manage_notification' or tbl_permission_settings.page_type='manage_email_notification' or tbl_permission_settings.page_type='manage_whatsapp_message' or tbl_permission_settings.page_type='manage_whatsapp_group_message' or tbl_permission_settings.page_type='manage_email' or tbl_permission_settings.page_type='manage_email_cc') GROUP BY tbl_permission_settings.page_type,sorting_order order by sorting_order asc")->result();
			if(!empty($menu)){
			?>
			...
			<?php } 
			$menu = $this->db->query("select DISTINCT tbl_permission_settings.page_type,sorting_order from tbl_permission_settings,tbl_permission_page where tbl_permission_settings.page_type=tbl_permission_page.page_type and user_type='$user_type' and (tbl_permission_settings.page_type='manage_import' or tbl_permission_settings.page_type='manage_fail_log' or tbl_permission_settings.page_type='manage_low_stock_alert' or tbl_permission_settings.page_type='manage_orders' or tbl_permission_settings.page_type='manage_invoice' or tbl_permission_settings.page_type='manage_daily_report') GROUP BY tbl_permission_settings.page_type,sorting_order order by sorting_order asc")->result();
			if(!empty($menu)){
			?>
			<li <?php foreach($menu as $mymenu){ if($Page_menu==$mymenu->page_type) { ?> class="active" <?php } }?>>
				<a href="#">
