        ...
        { ?>
			...
			<div class="form-group">
				<div class="col-sm-12">
                    ...
                    <div class="col-sm-10">
						<textarea class="form-control" id="author" name="author" tabindex="1" placeholder="Author" autocomplete="off"><?php echo $row->author ?></textarea>
                    </div>
			...
			<div class="form-group">	
				<div class="col-sm-12">
                    ...
                    <div class="col-sm-10">
						<textarea class="form-control" id="description" name="description" tabindex="1" placeholder="Description" autocomplete="off"><?php echo $row->description ?></textarea>
                    </div>
                    <div class="help-inline col-sm-12 has-error">
                        <span class="help-block reset middle">
			...
			<div class="form-group">	
				<div class="col-sm-12">
                    ...
                    <div class="col-sm-10">
						<textarea class="form-control" id="keywords" name="keywords" tabindex="1" placeholder="Keywords" autocomplete="off"><?php echo $row->keywords ?></textarea>
                    </div>
                    <div class="help-inline col-sm-12 has-error">
                        <span class="help-block reset middle">
                            <?= form_error('keywords'); ?>
			...
			<div class="form-group">	
				<div class="col-sm-12">
                    ...
                    <div class="col-sm-10">
						<input type="text" class="form-control" id="url" name="url" tabindex="1" placeholder="Url" autocomplete="off" value="<?php echo $row->url ?>" />
                    </div>
                    <div class="help-inline col-sm-12 has-error">
                        <span class="help-block reset middle">
                            <?= form_error('url'); ?>
			...
			<div class="form-group">	
				<div class="col-sm-12">
                    ...
                    <div class="col-sm-10">
						<textarea class="form-control" id="seo_google" name="seo_google" tabindex="1" placeholder="Seo Google" autocomplete="off"><?php echo $row->seo_google ?></textarea>
                    </div>
                    <div class="help-inline col-sm-12 has-error">
                        <span class="help-block reset middle">
