					...
					<div class="col-sm-4 text-right">
						...
						<div class="col-sm-8">
							<select name="main_type_id" id="main_type_id" class="form-control">
								<option value="1" <?php if(set_value('main_type_id')==1) { ?> selected <?php } ?>>Slider 1</option>
								<option value="2" <?php if(set_value('main_type_id')==2) { ?> selected <?php } ?>>Slider 2</option>
						</select>
					</div>
