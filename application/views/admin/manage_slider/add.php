    ...
    <div class="col-xs-12">
        ...
        <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
           <div class="form-group">					<div class="col-sm-6">                    <div class="col-sm-4 text-right">                        <label class="control-label" for="form-field-1">                            Slider Type                        </label>                    </div>                    <div class="col-sm-8">                        <select name="slider_type" id="slider_type" class="form-control">							<option value="1" <?php if(set_value('slider_type')==1) { ?> selected <?php } ?>>								Slider 1							</option>							<option value="2" <?php if(set_value('slider_type')==2) { ?> selected <?php } ?>>								Slider 2							</option>						</select>                    </div>                    <div class="help-inline col-sm-12 has-error">                        <span class="help-block reset middle">                              <?= form_error('slider_type'); ?>                        </span>                    </div>                </div>								<div class="col-sm-6">                    <div class="col-sm-4 text-right">                        <label class="control-label" for="form-field-1">							Short Order                        </label>                    </div>                    <div class="col-sm-8">						<input type="number" class="form-control" id="short_order" name="short_order" placeholder="Short Order" value="" min=0 required />                    </div>                    <div class="help-inline col-sm-12 has-error">                        <span class="help-block reset middle">                            <?= form_error('short_order'); ?>                        </span>                    </div>                </div>			</div>						<div class="form-group">
				...
				<div class="col-sm-6 funtype_all funtype_1">
                    <div class="col-sm-4 text-right">
                        <label class="control-label" for="form-field-1">
                            Select Item
                        </label>
			...
			<div class="form-group funtype_all funtype_2">
				<div class="col-sm-6">
                    <div class="col-sm-4 text-right">
                        <label class="control-label" for="form-field-1">
                            Select Company
