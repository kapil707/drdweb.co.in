    ...
    <div class="col-xs-12">
        ...
        <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">			
					...
					<div class="col-sm-4 text-right">
						...
						<div class="col-sm-8">
							<select name="slider_type" id="slider_type" class="form-control">
								<option value="1" <?php if(set_value('slider_type')==1) { ?> selected <?php } ?>>Slider 1</option>
								<option value="2" <?php if(set_value('slider_type')==2) { ?> selected <?php } ?>>Slider 2</option>
						</select>
					</div>
			...
			<div class="form-group">	
				<div class="col-sm-6">
                    ...
                    <div class="col-sm-8">
                        <select name="function_type" id="function_type" class="form-control" onchange="onchange_function_type()">
							<option value="0" <?php if(set_value('function_type')=="0"){ ?> selected <?php } ?>>
								Not Need
							</option>
				...
				<div class="col-sm-6 div_medicine" <?php if(set_value('function_type')!=1) { ?>style="display:none;" <?php } ?>>
                    <div class="col-sm-4 text-right">
                        <label class="control-label" for="form-field-1">
                            Select Medicine
                        </label>
