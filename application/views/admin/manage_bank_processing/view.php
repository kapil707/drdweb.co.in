						...
						<td>
							<div class="row">
								...
								<div class="col-sm-12">
									...
									<span class='<?php if((strtolower($row_whatsapp_chemist)==strtolower($row_chemist_id)) && $row_whatsapp_chemist!="N/a"){ echo "text_find_match"; } if(strtolower($row_whatsapp_chemist)!=strtolower($row_chemist_id)) { echo "text_find_match_not blink_me"; }?>'>WhatsApp Text :</span></b>
									<?= ($row_whatsapp_text); ?>
								</div>
								<?php } ?>
