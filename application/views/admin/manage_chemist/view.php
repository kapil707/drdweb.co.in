			...
			<table class="table table-striped table-bordered table-hover">
                ...
                foreach ($result as $row)
                {
                    ...
                    <tr id="row_<?= $row->id; ?>">
						...
						<td>
							<div class="btn-group"><a href="edit/<?php echo $row->id;?>" class="btn-white btn btn-xs">Edit</a></div>
                        </td>
						<td>
							<?php if($row->id2!="") { ?>
								<a href="javascript:void(0)" onclick=logout_fun('<?= ($row->altercode); ?>')>Logout</a>
							<?php } ?>
                        </td>
					</tr>
					<?php
