...
class Cronjob_chemist extends CI_Controller 
{
	...
	public function active_inactive_chemist()
	{
		...
		$result = $this->db->query("SELECT tbl_chemist.code,tbl_chemist.altercode FROM `tbl_chemist` join tbl_chemist_other on tbl_chemist.code=tbl_chemist_other.code WHERE tbl_chemist.STATUS='*' and altercode='S812'")->result();
