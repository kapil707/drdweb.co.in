...
<?php
	...
	{
		//https://drdistributor.com/new_api/api_mobile45/home_page_api/get?submit=98c08565401579448aad7c64033dcb4081906dcb&device_id=ok&user_altercode=v153&user_password=123123123&user_type=chemist&versioncode=32&firebase_token=ok&count_medicine=0&count_draft=0&getlatitude=xx&getlongitude=xx&gettime=10&getdate=2021-10-292021-10-29
		...
		if($submit==$submit1)
		{
			...
			{
				$get_record = 0;
				$box1 = $this->Chemist_Model->my_invoice_api($user_type,$user_altercode,$salesman_id,$get_record);
				$box1 = "[$box1]";
			}
