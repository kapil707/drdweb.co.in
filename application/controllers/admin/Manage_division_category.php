...
class Manage_division_category extends CI_Controller {

	var $Page_title = "Manage Division Category";
	var $Page_name  = "manage_division_category";
	var $Page_view  = "manage_division_category";
	var $Page_menu  = "manage_division_category";
	var $page_controllers = "manage_division_category";
	var $Page_tbl   = "tbl_division_category";
