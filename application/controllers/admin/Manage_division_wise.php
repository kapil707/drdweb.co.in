...
class Manage_division_wise extends CI_Controller {

	var $Page_title = "Manage Division Wise";
	var $Page_name  = "manage_division_wise";
	var $Page_view  = "manage_division_wise";
	var $Page_menu  = "manage_division_wise";
	var $page_controllers = "manage_division_wise";
