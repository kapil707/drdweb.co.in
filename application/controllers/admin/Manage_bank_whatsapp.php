...
class Manage_bank_whatsapp extends CI_Controller {
	...
	public function view()
	{
		...
		$result = $this->BankModel->select_query("SELECT wm.*, bp.final_chemist FROM tbl_whatsapp_message AS wm LEFT JOIN tbl_bank_processing AS bp ON bp.whatsapp_id = wm.id WHERE wm.date BETWEEN '$start_date' AND '$end_date'");
