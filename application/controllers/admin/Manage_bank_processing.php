...
class Manage_bank_processing extends CI_Controller {
	...
	public function view()
	{
		...
		$query = $this->BankModel->select_query("SELECT tbl_whatsapp_message.vision_text,tbl_bank_processing.* FROM `tbl_bank_processing` left JOIN tbl_whatsapp_message ON tbl_whatsapp_message.id = tbl_bank_processing.whatsapp_message_id WHERE tbl_bank_processing.date BETWEEN '$start_date' AND '$end_date' order by tbl_bank_processing.statment_id asc");
