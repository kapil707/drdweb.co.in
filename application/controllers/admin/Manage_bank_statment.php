...
class Manage_bank_statment extends CI_Controller {
	...
	public function view()
	{
		...
		$query = $this->BankModel->select_query("SELECT s.*,p.chemist_final as chemist_id,p.final_find_by as done_find_by,p.status as done_status,p.download_easysol as download_easysol,p.checkbox_done_status as checkbox_done_status,p.id as pid from tbl_statment as s left JOIN tbl_bank_processing as p on p.upi_no=s.customer_reference where s.date BETWEEN '$start_date' AND '$end_date'");
	...
	public function view2()
	{
		...
		//echo "SELECT s.*,p.chemist_final as chemist_id,p.final_invoice as done_invoice,p.final_find_by as done_find_by,p.status as done_status,p.download_easysol as download_easysol,p.checkbox_done_status as checkbox_done_status,p.id as pid from tbl_statment as s left JOIN tbl_bank_processing as p on p.upi_no=s.customer_reference where formet=2 and s.date BETWEEN '$start_date' AND '$end_date'";
