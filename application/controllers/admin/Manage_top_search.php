...
class Manage_top_search extends CI_Controller {
	var $Page_title = "Manage Top Search";	
	var $Page_name  = "manage_top_search";
	var $Page_view  = "manage_top_search";
	var $Page_menu  = "manage_top_search";
	var $page_controllers = "manage_top_search";
	...
	public function view()
	{
		...
		$result = $this->db->query("select DISTINCT item_code,count(id) as total from $tbl GROUP by item_code")->result();
		...
		$query = $this->db->query("select DISTINCT item_code,count(id) as total from $tbl GROUP by item_code LIMIT $per_page,100");
