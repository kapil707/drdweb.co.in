...
class Manage_master_meter extends CI_Controller {
	var $Page_title = "Manage Meter";
	var $Page_name  = "manage_master_meter";
	var $Page_view  = "manage_master_meter";
	var $Page_menu  = "manage_master_meter";
	var $page_controllers = "manage_master_meter";
	var $Page_tbl   = "tbl_meter";
