...
class Manage_master_attendance extends CI_Controller {
	var $Page_title = "Manage Attendance";
	var $Page_name  = "manage_master_attendance";
	var $Page_view  = "manage_master_attendance";
	var $Page_menu  = "manage_master_attendance";
	var $page_controllers = "manage_master_attendance";
	var $Page_tbl   = "tbl_attendance";
