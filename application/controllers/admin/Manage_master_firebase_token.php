...
class Manage_master_firebase_token extends CI_Controller {
	var $Page_title = "Manage Firebase Token";
	var $Page_name  = "manage_master_firebase_token";
	var $Page_view  = "manage_master_firebase_token";
	var $Page_menu  = "manage_master_firebase_token";
	var $page_controllers = "manage_master_firebase_token";
	var $Page_tbl   = "tbl_firebase_token";
	...
	public function view()
	{
		...
		$query = $db_master->query("select * from $tbl");
