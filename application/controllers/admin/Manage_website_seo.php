...
class Manage_website_seo extends CI_Controller {
	var $Page_title = "Manage Website Seo";
	var $Page_name  = "manage_website_seo";
	var $Page_view  = "manage_website_seo";
	var $Page_menu  = "manage_website_seo";
	var $page_controllers = "manage_website_seo";
