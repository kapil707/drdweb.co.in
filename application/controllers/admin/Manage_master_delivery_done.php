...
class Manage_master_delivery_done extends CI_Controller {
	var $Page_title = "Manage Delivery Done";
	var $Page_name  = "manage_master_delivery_done";
	var $Page_view  = "manage_master_delivery_done";
	var $Page_menu  = "manage_master_delivery_done";
	var $page_controllers = "manage_master_delivery_done";
	var $Page_tbl   = "tbl_delivery_photo";
