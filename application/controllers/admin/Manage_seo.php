...
class Manage_seo extends CI_Controller {
	var $Page_title = "Manage Seo";
	var $Page_name  = "manage_seo";
	var $Page_view  = "manage_seo";
	var $Page_menu  = "manage_seo";
	var $page_controllers = "manage_seo";
	var $Page_tbl   = "tbl_seo";
