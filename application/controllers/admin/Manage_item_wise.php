...
class Manage_item_wise extends CI_Controller {

	var $Page_title = "Manage Item Wise";
	var $Page_name  = "manage_item_wise";
	var $Page_view  = "manage_item_wise";
	var $Page_menu  = "manage_item_wise";
	var $page_controllers = "manage_item_wise";
	var $Page_tbl   = "tbl_item_wise";
