...
<?php
	...
	public function home_page_api($page_type)
	{
		...
		if($submit==$submit1)
		{
			...
			$medicine_json1 = $medicine_json4;//$this->Chemist_Model->new_medicine_this_month_json_new();
			$medicine_json1 = "[$medicine_json1]";
			
			/**********************must_buy_medicines_json************/
			$medicine_json2 = $medicine_json4;//$this->Chemist_Model->hot_selling_today_json_new();
			$medicine_json2 = "[$medicine_json2]";

			/**********************short_medicines_available_now_json******/
			$medicine_json3 = $medicine_json4;//$this->Chemist_Model->must_buy_medicines_json_new();
			$medicine_json3 = "[$medicine_json3]";

			/**********************new 5 number box************/
			//$medicine_json4 = $medicine_json4;//$this->Chemist_Model->frequently_use_medicines_json_new();
			$medicine_json4 = "[$medicine_json4]";
			/***************************************************/

			/**********************new 5 number box************/
			$medicine_json5 = $medicine_json4;//$this->Chemist_Model->stock_now_available();
			...
			$medicine_json6 = $medicine_json4;//$this->Chemist_Model->user_top_search_items($user_type,$user_altercode,$salesman_id);
